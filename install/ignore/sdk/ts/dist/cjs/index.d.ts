...
export type { User, ConversationSummary, ConversationDetails, ConversationMember, ConversationKind, MemberRole, Sender, ChatMessage, ContentType, UploadResult, GatewayEvent, GatewayEventType, ConnectionStatus, } from "./types.js";
...
export declare function createClient(options: AirwayIMOptions): AirwayIM;
