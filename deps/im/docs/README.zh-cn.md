...
| [`sdk/miniprogram/`](../../../sdk/miniprogram/) | 微信小程序 / 浏览器 SDK（npm 包）：类型化 REST 客户端、实时网关、基于 sequence 的同步引擎，内置 wx 与浏览器适配器 | — |
...
客户端无需手写上述协议：[`sdk/miniprogram/`](../../../sdk/miniprogram/) 下的
小程序 / 浏览器 SDK 把 REST API、网关协议（首帧认证、心跳、退避重连、事件去重）
