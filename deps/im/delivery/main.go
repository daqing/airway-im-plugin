...
func loadConfig() config {
	...
	return config{addr: envOr("DELIVERY_ADDR", ":1920"), backendURL: strings.TrimRight(envOr("BACKEND_URL", "http://127.0.0.1:1905"), "/"), gatewayURL: strings.TrimRight(envOr("GATEWAY_URL", "http://127.0.0.1:1910"), "/"), internalSecret: os.Getenv("IM_INTERNAL_SECRET"), pollInterval: time.Duration(intervalMS) * time.Millisecond}
}
